...
public class ChamadaFalsa extends AppCompatActivity {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case (R.id.btn_ligar):
                    ...
                    if (ActivityCompat.checkSelfPermission(ChamadaFalsa.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
                        ActivityCompat.requestPermissions(ChamadaFalsa.this, new String[]{Manifest.permission.CALL_PHONE}, 0);
                    }
